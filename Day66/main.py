...
def get_random_cafe():
    ...
    #  The above cafe dictionary sends all the data, we can modify it further for the user to understand it better
    ...
    # But in most cases you might want to return all data you have on a particular record and it would drive crazy if you had to write out all that code for every route.
    # So another method, is to create a method in Cafe class so we can call that every time to send the data
...
@app.route("/repot-closed/<int:cafe_id>", methods =["DELETE"])
